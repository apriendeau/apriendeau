---
title: "Nidus - a development vector search"
date: "2026-06-09"
...
## The History and the Road Travelled
...
## Sqlite with sql-vector

I just stopped here. I am going to be honest: I didn't want another C program with FFI, but this was the next logical step.
...
After a night of designing and laying out the specs, I built the nest, or [nidus](https://nidus.duckedup.org/), which is Latin for nest. Everything I am going to lay out is subject to change because we are experimenting with these decisions, and if they were wrong, I will update this. With it, our compile times came back under a minute—one step closer to our goal of running everything locally.
